...
public class Input {
     ...
     */
    static byte byteInput(String message){
     ...
     * @return el número introducido.
     */
    static short shortInput(String message){
        System.out.print(message);
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
        boolean validAnswer = false;
        short value = 0;
    ...
    static boolean yesOrNoQuestion(String question){
    ...
    static String emailInput(String text){
